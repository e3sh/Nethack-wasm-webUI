...
// ============================================================================
// 先行開発モンスター構造化マスターデータ (純英語定義)
// ============================================================================
export const MONSTER_KNOWLEDGE_BASE = [
    {
        id: 'cockatrice',
        monOffset: 25, // NetHack cockatrice offset
        name: 'cockatrice',
        dangerLevel: 'LETHAL',
    ...
    },
    {
        ...
        name: 'floating eye',
        dangerLevel: 'HIGH',
        stats: { hd: 2, ac: 9, speed: 6, mr: 10 },
        attacks: [
            { type: 'gaze', effect: 'paralysis' }
        ],
        resistances: [],
        corpseInfo: {
            edible: true,
            poisonous: false,
            grantResist: 'telepathy'
        },
        tacticalAdvice: [
    ...
    },
    {
        ...
        attacks: [
            { type: 'bite', damage: '1d1', effect: 'shock' }
        ],
        resistances: ['shock'],
        corpseInfo: { edible: true, poisonous: false },
        tacticalAdvice: [
            'Moves only in cardinal directions (cannot move diagonally)'
        ]
    },
    {
        id: 'soldier_ant',
        ...
        attacks: [
            { type: 'bite', damage: '2d4', effect: 'poison' }
        ],
        resistances: ['poison'],
        ...
        tacticalAdvice: [
            ...
            'Ensure poison resistance before melee combat'
        ]
    },
    {
        id: 'mind_flayer',
        ...
        attacks: [
            { type: 'tentacle', damage: '2d1', effect: 'brain_eat' }
        ],
        resistances: [],
    ...
    },
    {
        ...
        name: 'lich',
        dangerLevel: 'LETHAL',
        stats: { hd: 11, ac: 0, speed: 6, mr: 85 },
        attacks: [
            { type: 'touch', damage: '1d10', effect: 'cold' },
            { type: 'spell', effect: 'summon' }
        ],
        resistances: ['cold', 'poison', 'sleep'],
        corpseInfo: { edible: false, poisonous: true },
        tacticalAdvice: [
            'High magic resistance, summons undead and casts dangerous spells',
            'Fire attacks are highly effective',
            'Engrave Elbereth or use potion/wand of fire'
        ]
    },
    {
        id: 'disenchanter',
        ...
        name: 'disenchanter',
        dangerLevel: 'HIGH',
        stats: { hd: 9, ac: -1, speed: 12, mr: 60 },
        attacks: [
            { type: 'touch', effect: 'disenchant' }
        ],
        resistances: [],
        corpseInfo: { edible: true, poisonous: false },
        tacticalAdvice: [
            'Disenchants wielded weapons and worn armor upon attack',
            'Fight unarmed, with unenchanted weapons, or throw weapons from distance'
        ]
    },
    {
        id: 'rust_monster',
        ...
        attacks: [
            { type: 'touch', effect: 'rust' }
        ],
        resistances: [],
        corpseInfo: { edible: true, poisonous: false },
        tacticalAdvice: [
            'Rusts and corrodes iron weapons and armor',
            'Use leather/wooden/crystal gear or fight unarmed'
        ]
    },
    {
        id: 'shopkeeper',
        ...
        name: 'shopkeeper',
        dangerLevel: 'LETHAL',
        stats: { hd: 12, ac: 0, speed: 18, mr: 50 },
        attacks: [
            { type: 'weapon', damage: '4d6' }
        ],
        resistances: [],
        corpseInfo: { edible: true, poisonous: false },
        tacticalAdvice: [
            'Extremely dangerous and fast, equipped with shotgun-like wand charges',
            'Never attack or steal unless fully prepared with reflection/Wand of Death'
        ]
    },
    {
        id: 'medusa',
        ...
        name: 'medusa',
        dangerLevel: 'LETHAL',
        stats: { hd: 11, ac: 2, speed: 12, mr: 50 },
        attacks: [
            { type: 'gaze', effect: 'petrify' }
        ],
        resistances: ['stoning', 'poison'],
        corpseInfo: { edible: false, poisonous: true },
        tacticalAdvice: [
            'Gaze petrifies instantly',
            'Use a mirror to reflect her gaze, or wear blindfold/towel'
        ]
    },
    {
        id: 'jackal',
    ...
    },
    {
        ...
        attacks: [{ type: 'weapon', damage: '1d4' }],
        resistances: [],
        tacticalAdvice: ['Slow humanoid', 'May carry weapons or daggers']
    },
    {
        id: 'orc',
        monOffset: 20,
        name: 'orc',
        dangerLevel: 'LOW',
        stats: { hd: 1, ac: 6, speed: 9, mr: 0 },
        attacks: [{ type: 'weapon', damage: '1d6' }],
        resistances: [],
        tacticalAdvice: ['Basic enemy', 'Poison resistance from corpse']
    },
    {
        id: 'giant_ant',
        monOffset: 11,
        ...
        resistances: [],
        tacticalAdvice: ['Fast moving ant', 'Bottleneck in corridor']
    },
    {
        id: 'leocrotta',
        monOffset: 85,
        name: 'leocrotta',
        dangerLevel: 'HIGH',
        stats: { hd: 6, ac: 4, speed: 18, mr: 10 },
        attacks: [{ type: 'bite', damage: '2d6' }, { type: 'claw', damage: '1d8' }],
        resistances: [],
        tacticalAdvice: ['Very fast and deals heavy physical damage']
    },
    {
        id: 'vampire',
        monOffset: 140,
        name: 'vampire',
        dangerLevel: 'HIGH',
        stats: { hd: 8, ac: 1, speed: 12, mr: 30 },
        attacks: [{ type: 'bite', damage: '1d6', effect: 'drain_level' }],
        resistances: ['cold', 'poison', 'sleep'],
        tacticalAdvice: ['Drains experience level', 'Use garlic or Elbereth']
    },
    {
        id: 'arch_lich',
        monOffset: 162,
        name: 'arch-lich',
        dangerLevel: 'LETHAL',
        stats: { hd: 15, ac: -6, speed: 9, mr: 90 },
        attacks: [{ type: 'touch', damage: '1d10', effect: 'cold' }, { type: 'spell', effect: 'summon' }],
        resistances: ['cold', 'poison', 'sleep'],
        tacticalAdvice: ['Top-tier undead caster', 'Requires reflection and high magic resistance']
    },
    {
        id: 'purple_worm',
        monOffset: 180,
    ...
    },
    {
        ...
        name: 'red dragon',
        dangerLevel: 'LETHAL',
        stats: { hd: 10, ac: -1, speed: 9, mr: 20 },
        attacks: [{ type: 'breath', damage: '6d6', effect: 'fire' }],
        resistances: ['fire'],
        corpseInfo: { edible: true, poisonous: false, grantResist: 'fire resistance' },
        tacticalAdvice: ['Fires devastating fire breath', 'Fire resistance or reflection required']
    },
    {
        id: 'black_dragon',
        monOffset: 195,
        ...
        corpseInfo: { edible: true, poisonous: false, grantResist: 'disintegration resistance' },
        tacticalAdvice: ['Disintegration breath destroys gear and kills player instantly', 'Reflection or disintegration resistance mandatory']
    }
];
