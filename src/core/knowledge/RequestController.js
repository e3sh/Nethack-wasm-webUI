...
// 後方互換性担保（グローバル window / globalThis 参照および CJS / ESM デフォルトエクスポート）
if (typeof window !== 'undefined') window.RequestController = RequestController;
if (typeof globalThis !== 'undefined') globalThis.RequestController = RequestController;
