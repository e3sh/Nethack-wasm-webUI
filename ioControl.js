...
class ioControl extends GameTask {
	...
	pre(g) {// 最初の実行時に実行。
		...
		const cp = [
			...
			[80, 24, "std", false,	 8, 16, 48, 0, null], //0: mainscreen stdbg
			[80, 24, "std", PTUB,	 8, 16, 48, 0, "rgb(  0  0  64/0.25)"], //1: mainscreen_fg stdbg
			[80, 3,	 "std", false,	 8, 16, 64, 384, "rgb(128  0   0)"], //2:statusbar
			[108,36, "std_l", PTMSG, 8, 16, 48, 432, "rgb(  0  0 100)", true], //3:msg std_l
			[60, 32, "std_l", false, 8, 16, 480, 48, "rgb(  0  0 144/0.7 )", true], //4:window  std_l
